package com.montrackjpa.JPASpringBootExercises.config;


import com.montrackjpa.JPASpringBootExercises.auth.service.impl.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("api/v1/users/forgot_password").permitAll();
